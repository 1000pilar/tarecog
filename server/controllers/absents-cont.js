...
module.exports = {
  ...
  pushStudent: (req, res) => {
    const newStudent = {
          ...
          pertemuan_8: req.body.pertemuan_8 || "",
          pertemuan_9: req.body.pertemuan_9 || "",
          pertemuan_10: req.body.pertemuan_10 || "",
          pertemuan_11: req.body.pertemuan_11 || "",
          pertemuan_12: req.body.pertemuan_12 || "",
          pertemuan_13: req.body.pertemuan_13 || "",
          pertemuan_14: req.body.pertemuan_14 || ""
        }
    Absent.findByIdAndUpdate(req.params.id, {$push: {"student_list": newStudent}},
    {safe: true, upsert: true}, (erro, rezponse) => {
        if (!erro) {
 ...
 update: (req, res)=>{
    Absent.findOne({student_list: {$elemMatch: {_id:req.params.student_id}}},
      (err, result)=>{
      if(!err){
        ...
        var query = {
            ...
            pertemuan_8: req.body.pertemuan_8 || index[0].pertemuan_8,
            pertemuan_9: req.body.pertemuan_9 || index[0].pertemuan_9,
            pertemuan_10: req.body.pertemuan_10 || index[0].pertemuan_10,
            pertemuan_11: req.body.pertemuan_11 || index[0].pertemuan_11,
            pertemuan_12: req.body.pertemuan_12 || index[0].pertemuan_12,
            pertemuan_13: req.body.pertemuan_13 || index[0].pertemuan_13,
            pertemuan_14: req.body.pertemuan_14 || index[0].pertemuan_14
          }
        Absent.findOneAndUpdate({student_list: {$elemMatch: {_id:index[0]._id}}},
          {$set: {"student_list.$": query,
